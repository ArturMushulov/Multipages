...
function () {
  ...
  _createClass(Download, [{
    key: "downloadedItem",
    value: function downloadedItem(path) {
    ...
    value: function init() {
      ...
      this.btns.forEach(function (item) {
        item.addEventListener('click', function (e) {
          ...
          _this.downloadedItem(_this.path);
        });
      });
    }
  }]);
    ...
    value: function init() {
      this.btns.forEach(function (btn) {
        btn.addEventListener('click', function () {
          var siblingMSG = btn.closest('.module__info-show').nextElementSibling;
...
function (_Slider) {
  ...
  function MainSlider(btns, nextBtnSecondPage, prevBtnSecondPage) {
    _classCallCheck(this, MainSlider);

    return _possibleConstructorReturn(this, _getPrototypeOf(MainSlider).call(this, btns, nextBtnSecondPage, prevBtnSecondPage));
  }
  ...
  _createClass(MainSlider, [{
    ...
    value: function bindTriggers() {
      ...
      this.nextBtnSecondPage.forEach(function (btn) {
      ...
      this.prevBtnSecondPage.forEach(function (btn) {
        btn.addEventListener('click', function (e) {
          e.stopPropagation();
          e.preventDefault();
...
var Slider = function Slider() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      _ref$nextBtnSecondPag = _ref.nextBtnSecondPage,
      nextBtnSecondPage = _ref$nextBtnSecondPag === void 0 ? null : _ref$nextBtnSecondPag,
      _ref$prevBtnSecondPag = _ref.prevBtnSecondPage,
      prevBtnSecondPage = _ref$prevBtnSecondPag === void 0 ? null : _ref$prevBtnSecondPag,
